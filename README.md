...
```sh
ansible-galaxy install elastic.elasticsearch,v7.17.2
```
...
The above installs Elasticsearch 7.17.2 in a single node 'node1' on the hosts 'localhost'.
